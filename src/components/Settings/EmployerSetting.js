...
const EmployerSetting = ({perJob, allJobs, showPerJob }) => {

    const [createJob, showCreateJob] = useState(false)
    const [editJob, showEditJob] = useState(false)
                ...
                <div  className = "setting">
                    <div className = "col-md-10 d-flex mb-5 justify-content-center">
                        ...
                        <div className="col-md-1 mt-3">
                            <button type="button" className="btn btn-success check" onClick = {()=> {
                                                showCreateJob(true)

...
const Jobs = ({perJob, allJobs,  setPage, page, showPerJob, pageCount}) => {
                ...
                <div className = "background">
                    <div className="d-flex">
                        ...
                        <div className = "col md-8" >
                            ...
                            <div className = "col-md-11 perjob">
                            {allJobs.map((note, i) =>{
                            return (
                                <div className = " d-flex border-bottom py-3" key={`note-${i}`} >
                    ...
                    <div className = "shadow-lg col-8">
                        ...
                        <div className = "my-4 flex row justify-content-around">
                            ...
                            <div className = "col-6">
                                ...
                                <p>{job.gender}</p>
                                <p>{job.salary}</p>
                                <p>{job.location.country} {job.location.state} {job.location.city}</p>
                            </div>
                        </div>
                        <div className = " m-4">

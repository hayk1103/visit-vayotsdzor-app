...
const Home = () => {
    ...
    return (
        <div>
            { !jobs && !talents && (<main>
                <div className="card bg-transparent text-center row text" id = "job">
                    <div className="card-body  main_part_text col-6" >
                        ...
                        <div>
                            <p style = {{fontSize: 30 + 'px'}}  className="lead">Together we can achieve more...!!!</p>
                        </div>
                        <div className = "d-inline-flex p-2 button_margin">
                        <BrowserRouter>
                            <button type="button" className="btn btn-dark mx-auto" onClick = {getJob}><NavLink to='/jobs' style = {{color: 'white'}}>Find Job</NavLink> </button>
                            <button type="button" className="btn btn-dark" onClick = {getTalent}><Link to='/talents'style = {{color: 'white'}}>Find Talents</Link></button>
                        </BrowserRouter>
